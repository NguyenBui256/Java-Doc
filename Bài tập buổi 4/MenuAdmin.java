...
public class MenuAdmin {
    ...
    public void themVo(Scanner sc, ArrayList<Notebook> notes)
    {
        ...
        notes.add(newNoteBook);
        System.out.println("Vở mới đã được thêm!!");
        System.out.println();
    }

    public void themButMuc(Scanner sc, ArrayList<Pen> pens)
    {
    ...
    public void themButChi(Scanner sc, ArrayList<Pencil> pencils)
    {
        System.out.println("Nhập tên bút: ");
        String ten = sc.nextLine();
        System.out.println("Nhập giá bán: ");
